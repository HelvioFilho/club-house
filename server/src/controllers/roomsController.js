...
export default class RoomsController {
  ...
  #logoutUser(socket) {
    ...
    // caso seja um usuário "sujeira" que estava em uma sala que não existe
    ...
    // se não tiver mais nenhum usuário na sala, removemos a sala
    if (!room.users.size) {
    ...
    // verificar se tem somente um usuário ou se o usuário era o dono da sala
